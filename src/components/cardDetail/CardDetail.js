...
function CardDetail({ toggle, setToggle, image }) {
    ...
    return (
        <div onClick={() => { setToggle(!toggle) }} className='transition-all z-10 overflow-hidden flex justify-center items-center fixed  bg-[#00000080] top-0 bottom-0 left-0 right-0 bg-[rgba(0, 0, 0, 0.50)]'>
            <Zoom duration={200} className='flex justify-center items-center z-50'>
                <div className='bg-white rounded-lg max-w-[95%] max-h-[80%]'>
                    {/* header */}
                    ...
                    <div className='flex flex-row px-5 gap-5 py-6'>
                        ...
                        <aside className='w-[30%]'>
                            ...
                            <div>
                                ...
                                <button className='w-full text-center bg-[#4BC34B] py-2 rounded-md text-white font-semibold'>
                                    Download for free!
                                </button>
                            </div>
                            {/* image informations */}
